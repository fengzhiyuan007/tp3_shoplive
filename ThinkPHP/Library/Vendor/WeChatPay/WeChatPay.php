...
Class WeChatPay extends Common{
    ...
    //支付成功回调地址服务器回调地址
    // const NOTIFY = 'http://shtlcm.cn/App/Pingxx/wxpayCallback';
    // const NOTIFY = 'http://shtlcm.tstmobile.com/App/Pingxx/wxpayCallback';
    const NOTIFY = 'http://tp3shoplive.zhongfeigou.com/App/Pingxx/wxpayCallback';
    //********************************公共配置参数结束***************************************************//
    //********************************app支付开放平台相关配置参数开始***************************************************//
    //微信开放平台的应用appid
    private $open_appid = '';
    ...
    public function __construct(){
        //开放平台
        $this->open_appid= C('OPEN_APPId');
        $this->open_mchid= C('OPEN_MCHID');
        $this->open_key= C('OPEN_KEY');
        //公众号
        $this->appid= C('APPId');
        $this->mchid= C('MCHID');
        $this->key= C('KEY');
