	  ...
	  <TBODY>
		  <TR>
		     <TD height=40 width="61%">
		    	<h2><font color="white">商户管理后台</font></h2>
		    </A></TD>
		    <TD vAlign=top width="39%">
		      <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
		        <TBODY>
		        <TR>
		          <TD height=38 align="right" class=admin_txt>&nbsp;&nbsp; 商户 ：<B><?php echo ($_SESSION["shop"]["merchants_name"]); ?></B> 您好！
		           ...
		           <a href="/cleancache.php" target="main"><IMG style="margin-top:5px;position: relative ;top:8px;" border="0" alt="安全退"出 src="/Public/admin/images/clearcache_bnt.jpg"></a>
				    <A onClick="logout();" href="javascript:void(0);"><IMG style="margin-top:5px;position: relative ;top:8px;" border="0" alt="安全退出" src="/Public/admin/images/tuichu_bnt.jpg"></A>
				  </TD>
		          </TR>
		        <TR>
		        <TD width="3%">&nbsp;</TD>
