...
<div class="page-container">
    <div class="text-l">
        <form class="search"  method="get">
            ...
            <input type="text" class="input-text" style="width:250px" name="username" value="<?php echo ($_GET['username']); ?>" id="username" placeholder="搜索送礼会员昵称">
            ...
            <div style="float: right;padding: 5px">
                收益
                <a href="javascript:void(0)"><?php echo ((isset($sum) && ($sum !== ""))?($sum):'0'); ?> 钻石</a>
            </div>
        </form>
    </div>
    ...
    用户 <a href="javascript:void(0);"><u><?php echo ($_GET['username']); ?></u></a>
    {/if}-->
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
                ...
                <td><?php echo ($vo["price"]); ?>＊<?php echo ($vo["number"]); ?></td>
                <td><?php echo ($vo["total"]); ?></td>
                <td>
                    <span style="display: block; font-size: 8%">
                    <?php echo ($vo["username"]); ?><br/>
                   <!--  <?php echo ($vo["anchor_amount"]); ?>钻石<br/>
                    <?php echo ($vo["anchor_ratio"]); ?>%</span> -->
                </td>
...
//		}
    ...
    function getnums(){
        var num = $("#nus").val();
        window.location.href="/Merchant/Index/give_gift.html&num="+num;
    }
