...
<div class="page-container">
    <div class="text-l">
        <form class="search"  method="get">
            ...
            <input type="text" class="input-text" style="width:200px" name="order_no" value="<?php echo ($Request["get"]["order_no"]); ?>" id="order_no" placeholder="搜索订单号/申请人">
...
<script type="text/javascript">
    ...
    function getnums(){
        var num = $("#nus").val();
        window.location.href="/Merchant/Horder/refund.html&num="+num;
    }
