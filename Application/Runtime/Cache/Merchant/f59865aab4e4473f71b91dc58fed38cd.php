        ...
        <div class="mt-5">
            <table style="position: relative" class="table table-border table-bordered table-bg table-hover table-sort">
                ...
                <?php if(is_array($refund)): $i = 0; $__LIST__ = $refund;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
                    ...
                    <td>
                        <a title="详情" href="javascript:;;" onclick="category_edit('快递信息','<?php echo U('Horder/express',['order_no'=>$re['order_no']]);?>','4','','510')"   style="text-decoration:none">
                            <i class="Hui-iconfont">&#xe623;</i>
                        </a>
                    </td>
                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <form   method="post" class="form form-horizontal mt-5">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-8">
                    <textarea  cols="" rows="" class="textarea" placeholder="退换货原因"   readonly><?php echo ($re['refund_reason']); ?></textarea>
                </div>
            </div>
            <div class="row cl mt-5">
                <label class="form-label col-xs-4 col-sm-2">退换货原因描述：</label>
                <div class="formControls col-xs-8 col-sm-8">
                    <textarea name="refund_desc" cols="" rows="" class="textarea" placeholder="退换货原因描述" id="refund_desc" readonly><?php echo ($re["refund_desc"]); ?></textarea>
                </div>
            </div>
            <div class="row cl mt-5">
