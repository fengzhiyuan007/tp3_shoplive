...
<div class="page-container">
    <div class="text-l">
        <form class="search"  method="get">
            ...
            <input type="text" class="input-text" style="width:250px" placeholder="搜索标题" value="<?php echo ($_GET['name']); ?>" name="name">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><tr class="text-c">
                    ...
                    <td>
                        <?php if($l['is_shenhe'] == 2): ?><u><a href="javascript:;;" onClick="change_review(this,<?php echo ($vo["goods_id"]); ?>)"><span class="label label-success radius">已审核</span></a></u>
                        <?php else: ?>
                    ...
                    <td class="td-manage" style="text-align: center">
                        <a title="编辑" href="<?php echo U('Index/edit_video',['id'=>$l['video_id']]);?>"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
