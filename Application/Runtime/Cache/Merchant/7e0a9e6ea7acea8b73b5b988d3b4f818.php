...
<div class="page-container">
	<div class="text-l">
		<form class="search"  method="get">
			<input type="text" class="input-text" style="width:200px" placeholder="搜索商品名称、编号" value="<?php echo ($name); ?>" name="name">
			...
			<span style="float:right;padding:0px 10px 10px 0" >
                <a  href="<?php echo U('Goods/insert_goods');?>" class="check_auth btn btn-primary radius" >
		...
		<table style="" class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
					...
					<td class="td-manage">
						...
						<a title="编辑" href="<?php echo U('Goods/edit_goods',['goods_uuid'=>$vo['goods_uuid']]);?>"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
