...
<div class="page-container">
    <div class="text-l">
        <form class="search"  method="get">
            ...
            <input type="text" class="input-text" style="width:200px" name="order_no" value="<?php echo ($Request["get"]["order_no"]); ?>" id="order_no" placeholder="订单号/收件人电话">
        ...
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
                ...
                <td class="td-manage">
                    ...
                    <a title="订单恢复" href="javascript:;" onclick="recovery(this,<?php echo ($vo["order_merchants_id"]); ?>);" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe615;</i></a>
                </td>
...
<script type="text/javascript">
    ...
    function getnums(){
        var num = $("#nus").val();
        window.location.href="/Merchant/Horder/is_del_order.html&num="+num;
    }
