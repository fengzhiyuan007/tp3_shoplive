...
<!-----------------------------------------内容开始--------------------------------------------------->
<div class="infoBox">
<form name="form" action="<?php echo U('doadd_price');?>"  method="post" onsubmit="return checkss();">
<table width="90%" border="0" cellpadding="0" cellspacing="0" id="basic">
               <input type="hidden" value="<?php echo ($u["price_id"]); ?>" name="id">

                <tr>
                    <td  width="10%" class="infoBoxTd"><div style="width:55px;">价格:</div></td>
                    <td colspan="2"><input type="text" id="price"  name="price" value="<?php echo ($u["price"]); ?>" style="width:280px;"></td>
                </tr>
                <tr>
                    <td  width="10%" class="infoBoxTd"><div style="width:55px;">钻石:</div></td>
                    <td colspan="2"><input type="text" id="meters"  name="meters" value="<?php echo ($u["meters"]); ?>" style="width:280px;">钻石</td>
                </tr>
                <tr>
                    <td  width="10%" class="infoBoxTd"><div style="width:55px;">赠送:</div></td>
                    <td colspan="2"><input type="text" id="give"  name="give" value="<?php echo ($u["give"]); ?>" style="width:280px;">钻石</td>
                </tr>
                <tr>
                    <td  width="10%" class="infoBoxTd"><div style="width:55px;">内购id:</div></td>
                    <td colspan="2"><input type="text" id="apple_id"  name="apple_id" value="<?php echo ($u["apple_id"]); ?>" style="width:280px;"></td>
                </tr>
