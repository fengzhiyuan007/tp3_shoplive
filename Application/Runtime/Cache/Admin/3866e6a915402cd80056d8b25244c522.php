...
<!-----------------------------------------内容开始--------------------------------------------------->
<div class="infoBox">
<form name="form" action="<?php echo U('doadd_lebel');?>"  method="post" onsubmit="return checkss();">
<table width="90%" border="0" cellpadding="0" cellspacing="0" id="basic">
               <input type="hidden" value="<?php echo ($u["lebel_id"]); ?>" name="id">
                <tr>
                    <td  width="10%" class="infoBoxTd"><div style="width:55px;">类别:</div></td>
                    <td colspan="2">
                        <input type="radio" name="type" value="1" <?php if( $u["type"] == '' or $u["type"] == 1 ): ?>checked<?php endif; ?>>&nbsp;直播&nbsp;&nbsp;
                        <input type="radio" name="type" value="2" <?php if( $u["type"] == 2 ): ?>checked<?php endif; ?>>&nbsp;资讯
                    </td>
                </tr>
                <tr>
                    <td  width="10%" class="infoBoxTd"><div style="width:55px;">名称:</div></td>
                    <td colspan="2"><input type="text" id="name"  name="name" value="<?php echo ($u["name"]); ?>" style="width:280px;"></td>
                </tr>
