...
<article class="page-container">
	...
	<form class="form form-horizontal" id="form" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea rows="3" cols="100" name="summary"><?php echo ($re['summary']); ?></textarea>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">协议内容：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="content"  id="content1" style='width:100%;height:300px;'  placeholder="说点什么...最少输入10个字符" ><?php echo ($re['content']); ?></textarea>
			</div>
		</div>
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				...
				<input type="hidden" class="input-text" value="<?php echo ($_REQUEST["id"]); ?>" placeholder=""  name="id">
			</div>
		</div>
	</form>
</article>
