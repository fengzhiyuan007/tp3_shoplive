	...
	<form class="form form-horizontal" id="form" method="post">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="title" class="input-text" value="<?php echo ($re['title']); ?>" placeholder="标题" id="title" />
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				...
				<input type="hidden" class="input-text" value="<?php echo ($re["text_id"]); ?>" placeholder=""  name="text_id">
			</div>
		</div>
	</form>
</article>
