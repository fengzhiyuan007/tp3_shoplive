...
<div class="page-container">
	...
	<form class="form form-horizontal" id="form" method="post">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>布局类型：</label>
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="layout" class="select">
					<option value="3" <?php if($re['layout'] == 3): ?>selected<?php else: endif; ?>>长度3</option>
					<option value="4" <?php if($re['layout'] == 4): ?>selected<?php else: endif; ?>>长度4</option>
					<option value="5" <?php if($re['layout'] == 5): ?>selected<?php else: endif; ?>>长度5</option>
					<option value="6" <?php if($re['layout'] == 6): ?>selected<?php else: endif; ?>>长度6</option>
				</select>
				</span> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="select-box">
					<select name="type" class="select" onchange="changeMk(this.value)">
						...
						<option value="6" <?php if($re['type'] == 6): ?>selected<?php else: endif; ?>>标签</option>
					</select>
				</span>
			</div>
		</div>
		...
		<!--<div id="tag3" class='row tag cl <?php echo ($re["type == 3? '' : 'hiden'"]); ?>'>-->
			<!--<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>导师ID：</label>-->
			<!--<div class="formControls col-xs-8 col-sm-9">-->
				<!--<input type="text" class="input-text" value="<?php echo ($banner['value'] ? $banner['value'] : ''); ?>" placeholder="导师ID"  name="user" />-->
			<!--</div>-->
		<!--</div>-->
...
<script>
    ...
    //                     zNodes.push(object);
    //                     if (arr[i].seed && arr[i].seed.length > 0 ) {
