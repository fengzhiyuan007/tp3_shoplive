    ...
    <div class="cl pd-5 bg-1 bk-gray">
        <span class="l">
            <a href="javascript:;" onclick="datadel()" class="btn btn-danger radius">
                ...
                批量删除</a>
            <a class="btn btn-primary radius"  href="<?php echo U('Home/add_dress');?>">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
                ...
                <td><a href="<?php echo U('Home/edit_dress',['id'=>$vo['dress_id']]);?>"><u><?php echo ($vo["title"]); ?></u></a></td>
                ...
                <td class="td-manage">
                    ...
                    <a style="text-decoration:none" class="ml-5"  href="<?php echo U('home/seed_dress',['id'=>$vo['dress_id']]);?>" title="下级规则">
                        <i class="Hui-iconfont">&#xe681;</i>
                    </a>
                    <a style="text-decoration:none" class="ml-5"  href="<?php echo U('Home/edit_dress',['id'=>$vo['dress_id']]);?>" title="编辑">
                        <i class="Hui-iconfont">&#xe6df;</i>
                    </a>
