    ...
    <form class="form form-horizontal" id="form" method="post">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="specification_value" class="input-text" value="<?php echo ($re['specification_value']); ?>" placeholder="规格名称" id="specification_value" />
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">简介：</label>
            <div class="formControls col-xs-4 col-sm-9">
                <textarea name="specification_desc" cols="" rows="" style="height: 80px;" class="textarea"  placeholder="说点什么...最少输入3个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,100)"><?php echo ($re["specification_desc"]); ?></textarea>
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                ...
                <?php if($_GET["parent_id"] != '' ): ?><input type="hidden" name="parent_id" id="parent_id" value="<?php echo ($_GET['parent_id']); ?>" />
                <?php else: ?> 
                    <input type="hidden" name="parent_id" id="parent_id" value="-1" /><?php endif; ?>


                <input type="hidden" class="input-text" value="<?php echo ($re['specification_id']); ?>" placeholder=""  name="specification_id">
