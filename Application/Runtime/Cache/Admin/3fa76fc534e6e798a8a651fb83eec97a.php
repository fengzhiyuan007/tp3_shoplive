...
<div class="content">
	...
	<div class="infoBox">
		<form name="form" action="/Admin/Base/mall_config" method="post">
			<input type="hidden" name="id" value="<?php echo ($base["id"]); ?>">
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				id="basic">
				<tr bgcolor="white">
					<td width="18%" class="infoBoxTd" bgcolor="white">平台对商户抽成比：</td>
					<td colspan="2"><input type="number" min="0" max="100" step="0.01" id="merchants_per" name="merchants_per" size="10" value="<?php echo ($base["merchants_per"]); ?>">%&nbsp;&nbsp;注:0-100</td>
				</tr>

				<tr bgcolor="white">
					<td width="18%" class="infoBoxTd" bgcolor="white">商户对主播分成比：</td>
					<td colspan="2"><input type="number" min="0" max="100" step="0.01" id="goods_per" name="goods_per" size="10" value="<?php echo ($base["goods_per"]); ?>">%&nbsp;&nbsp;注:0-100</td>
				</tr>
