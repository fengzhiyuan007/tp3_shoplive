    ...
    <form class="form form-horizontal" id="form" method="post">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="class_name" class="input-text" value="<?php echo ($re['class_name']); ?>" placeholder="一级分类名" id="class_name" />
            </div>
        </div>
        <!-- <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <div class="droparea spot" id="image1" style="background-image: url('<?php echo ($re['class_img']); ?>');background-size: 220px 160px;" >
                    ...
                    <div class="instructions" style="top: 135px;color: red;background-color: #ece2e2;">建议尺寸750*350,图片小于2M</div>
                </div>
            </div>
        </div>
        <!--<div class="row cl">-->
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                ...
                <button type="submit" class="submit btn btn-primary radius" ><i class="Hui-iconfont">&#xe632;</i> 保存并提交</button>
