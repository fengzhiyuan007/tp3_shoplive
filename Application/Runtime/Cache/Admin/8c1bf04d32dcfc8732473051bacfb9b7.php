...
<div class="page-container">
	...
	<form class="form form-horizontal" id="form" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"><span class="select-box">
				<select name="type" class="select">
					<option value="1" <?php if($re['type'] == 1): ?>selected<?php else: endif; ?>>直播首页</option>
					<option value="2" <?php if($re['type'] == 2): ?>selected<?php else: endif; ?>>商城首页</option>
					<option value="3" <?php if($re['type'] == 3): ?>selected<?php else: endif; ?>>直播列表</option>
					<option value="4" <?php if($re['type'] == 4): ?>selected<?php else: endif; ?>>优惠券</option>
				</select>
				</span></div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="select-box">
					<select name="b_type" class="select" onchange="changeMk(this.value)">
						<option value="1" <?php if($re['b_type'] == 1): ?>selected<?php else: endif; ?>>无跳转</option>
						<option value="2" <?php if($re['b_type'] == 2): ?>selected<?php else: endif; ?>>web页链接</option>
						<option value="3" <?php if($re['b_type'] == 3): ?>selected<?php else: endif; ?>>分类页</option>
						<option value="4" <?php if($re['b_type'] == 4): ?>selected<?php else: endif; ?>>商家</option>
						<option value="5" <?php if($re['b_type'] == 5): ?>selected<?php else: endif; ?>>商品</option>
						<option value="6" <?php if($re['b_type'] == 6): ?>selected<?php else: endif; ?>>优惠券</option>
						<!-- <option value="7" <?php echo ($re["b_type == 7 ? 'selected' : ''"]); ?>>标签</option> -->
						<option value="8" <?php if($re['b_type'] == 8): ?>selected<?php else: endif; ?>>用户</option>
					</select>
				</span>
			</div>
		</div>
		<div id="tag2" class="row tag cl <?php if($re['b_type'] == 2): else: ?>hiden<?php endif; ?>">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>跳转值：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($re['url']); ?>" placeholder="跳转WEB页"  name="url" />
			</div>
		</div>
		<div id="tag3" class="row tag cl <?php if($re['b_type'] == 3): else: ?>hiden<?php endif; ?>">
		...
		<div id="tag4" class="row tag cl <?php if($re['b_type'] == 4): else: ?>hiden<?php endif; ?>">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="select-box" style="width: 55%">
					<select id="merchant" name="merchant" class="select">
						<?php if(is_array($merchants)): $i = 0; $__LIST__ = $merchants;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["member_id"]); ?>" <?php if(($re['b_type'] == 4) AND ($re['jump'] == $vo['member_id'])): ?>selected<?php else: endif; ?>><?php echo ($vo["merchants_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
					</select>
				</span>
		...
		<div id="tag5" class="row tag cl <?php if($re['b_type'] == 5): else: ?>hiden<?php endif; ?>">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商品：</label>
			<div  class="formControls col-xs-8 col-sm-9">
				<span class="select-box" style="width: 55%">
					<select id="goods" name="goods" class="select">
						<?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["goods_id"]); ?>" <?php if(($re['b_type'] == 5) AND ($re['jump'] == $vo['goods_id'])): ?>selected<?php else: endif; ?>><?php echo ($vo["goods_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
					</select>
				</span>
		...
		<div id="tag6" class="row tag cl <?php if($re['b_type'] == 6): else: ?>hiden<?php endif; ?>">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>跳转值：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div id="tag8" class="row tag cl <?php if($re['b_type'] == 8): else: ?>hiden<?php endif; ?>">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>用户：</label>
			<div  class="formControls col-xs-8 col-sm-9">
				<span class="select-box" style="width: 55%">
					<select id="user" name="user" class="select">
						<?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["user_id"]); ?>" <?php if(($re['b_type'] == 8) AND ($re['jump'] == $vo['user_id'])): ?>selected<?php else: endif; ?>><?php echo ($vo["username"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
					</select>
				</span>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($re['sort']); ?>" placeholder="" id="sort" name="sort">
			</div>
		</div>
		<div class="row cl">
