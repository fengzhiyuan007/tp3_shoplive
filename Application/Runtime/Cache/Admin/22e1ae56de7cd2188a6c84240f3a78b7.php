    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
                ...
                <td class="text-c">
                    <?php switch($vo['b_type']){ case 1: echo "无跳转"; break; case 2: echo "Web页"; break; case 3: echo "分类"; break; case 4: echo "商家"; break; case 5: echo "商品"; break; case 6: echo "优惠券页"; break; case 8: echo "用户"; break; } ?></td>
                <td>
                    <?php switch($vo['type']){ case 1: echo "直播首页"; break; case 2: echo "商城首页"; break; case 3: echo "直播列表"; break; case 4: echo "优惠券"; break; } ?>
                </td>
